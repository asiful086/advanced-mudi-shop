...
import { DELETE_VARIATION } from "../../../graphql/mutations/variationMutation";
const AdminVariationListPage = ({ history }) => {
  // 1  ============================= COMPONENT STATE =========================
  ...
  const [deleteVariation, { loading: mutationLoading }] = useMutation(
    DELETE_VARIATION,
    {
      update(proxy, { data: { deleteVariation: returnedItem } }) {
        if (!state.unmounted) {
          ...
          if (data) {
            proxy.writeQuery({
              query: GET_VARIATIONS,
              data: {
                getVariations: data.getVariations.filter(
                  ...
                  mainDatas.map((mainData) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <Link to={`/admin/variation/edit/${mainData.id}`}>
...
export default AdminVariationListPage;
