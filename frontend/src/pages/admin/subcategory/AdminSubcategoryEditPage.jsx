...
const AdminSubcategoryEditPage = ({ history, match }) => {
  // 1  ============================= COMPONENT STATE =========================
  ...
  const {
    ...
    data: { getSubcategory: mainData } = {},
  } = useQuery(GET_SUBCATEGORY, {
    onError(err) {
      //   console.log(err);
  ...
  const [updateSubcategory, { loading: mutationLoading }] = useMutation(
    UPDATE_SUBCATEGORY,
    {
      update() {
        history.push("/admin/subcategory/list");
      },
      onError(err) {
        values.photo = "";
        values.name = "";
  ...
  function updateSubcategoryCallback() {
    updateSubcategory();
  }
            ...
            <img
              ...
              src={
                values.photo
                  ...
                  : mainData && `/images/subcategory/${mainData.photo}`
              }
              alt=""
            />
            <button
